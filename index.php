      ...
      <section class="testimonial-client">
        <div class="container">
          <div class="col-md-12">
            <div class="box-title-desc">
              <div class="title color-black bdr-btm-gray">
                <span class="bg-section">SOSIAL MEDIA KAMI</span>
              </div>
              <div class="desc color-black">
                Ikuti akun sosial media kami untuk menambahkan uptodate kegiatan dan seputar informasi RSI Amal Sehat Sragen
              </div>
            </div>
          </div>
          <div class="col-md-12">
            <div class="box-testimonial" id="owl-slide-testimonial">
              <div class="col-lg-12">
                <div class="item list-testimonial">
                  <div class="box-quote">
                    <p>
                      Kegiatan futsal bareng untuk menambah kesehatan karyawan
                    </p>
                  </div>
                  <div class="box-client">
                    ...
                    <div class="box-name-wrapper">
                      <div class="name">
                        <span class="name">
                          IG 
                          <span class="position">Amal Sehat</span>
                        </span>
                      </div>
                    </div>
                  </div>
              ...
              <div class="col-lg-12">
                <div class="item list-testimonial">
                  <div class="box-quote">
                    <p>
                      KEgiatan joking keliling stadiun 10 kali untuk menambah kesehatan jantung dan paru-paru
                    </p>
                  </div>
                  <div class="box-client">
                    <div class="box-avatar">
